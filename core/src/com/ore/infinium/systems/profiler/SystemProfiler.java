...
/**
 * {@link ArtemisProfiler} implementation, {@link SystemProfiler#dispose()} should be called to clean static references
 * as needed
 *
 * @author piotr-j
 */
public class SystemProfiler implements ArtemisProfiler {
    ...
    /**
     * @param index
     *         of profiler to get, no bounds check!
     *
    ...
    public String toString() {
        return name != null ? name : system != null ? system.getClass().getSimpleName() : "<dummy>";
    }
