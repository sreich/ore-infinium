...
open class BaseInventoryView(val title: String,
    ...
    init {
        val region = oreWorld.artemisWorld.system<TileRenderSystem>()
                .tilesAtlas.findRegion("dirt-00")
    ...
    protected fun slotTextureForEntity(itemEntity: Int, textureName: String): TextureRegion {
        ...
        if (mBlock.opt(itemEntity) != null) {
            ...
            region = oreWorld.artemisWorld.system<TileRenderSystem>()
                    .tilesAtlas.findRegion("$textureName-00")
        } else {
